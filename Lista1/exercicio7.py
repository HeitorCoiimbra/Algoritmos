# Exercício 7: Efetuar a leitura do número de quilowatts consumidos e calcular o valor a ser pago de 
# energia elétrica, sabendo-se que o valor a pagar por quilowatt é de 0,12. 
